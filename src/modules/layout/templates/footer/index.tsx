    ...
    <footer className="border-t border-ui-border-base w-full">
      <div className="content-container flex flex-col w-full">
          ...
          <div className="text-small-regular gap-10 md:gap-x-16 grid grid-cols-2 sm:grid-cols-3">
            ...
            <div className="flex flex-col gap-y-2">
              ...
              <ul className="grid grid-cols-1 gap-y-2 text-ui-fg-subtle txt-small">
                <li>
                  <LocalizedClientLink className="hover:text-ui-fg-base" href="/faq">
                    FAQ's
                  </LocalizedClientLink>
                </li>
                <li>
                  <LocalizedClientLink className="hover:text-ui-fg-base" href="/shipping-returns">
                    Shipping & Returns
                  </LocalizedClientLink>
                </li>
                <li>
                  <LocalizedClientLink className="hover:text-ui-fg-base" href="/terms-conditions">
                    Terms & Conditions
                  </LocalizedClientLink>
                </li>
              </ul>
        ...
        <div className="flex w-full mb-16 justify-center text-ui-fg-muted">
          <Text className="txt-compact-small">© {new Date().getFullYear()} Bumsurfboards. All rights reserved.</Text>
        </div>
      </div>
    </footer>
  )
